...
export const NAV_LINKS = [
    ...
    { href: '/cotizador', key: 'cotiza_tu_auto', label: 'Cotiza tu Auto' },
    { href: '/productos', key: 'productos', label: 'Productos' },
    { href: '/', key: 'servicios ', label: 'Servicios ' },
    { href: '/', key: 'nosotros', label: 'Nosotros' },
  ...
  export const FOOTER_LINKS = [
    ...
    },
    {
      ...
      links: ['Seguros', 'Fianzas', 'Educación'],
    },
  ];
  ...
  export const FOOTER_CONTACT_INFO = {
    title: 'Contacto',
    links: [
      { label: 'Teléfono', value: '664 508 9876' },
      { label: 'Email', value: 'contacto@cazseguros.com' },
    ],
  };
